...
![그림 3.1 산업용 통신 설정 화면](<../_assets/image_3_1.png>)

![그림 3.2 산업용 통신 설정 화면(master)](<../_assets/image_3_2.png>) ![그림 3.3 산업용 통신 설정 화면(Slave)](<../_assets/image_3_3.png>)

3\. **\[적용]** 메뉴를 터치하여 펌웨어 설정을 완료 합니다.

![그림 3.4 산업용 통신 설정 화면](<../_assets/image_3_4.png>)
...
![그림 3.5 산업용 통신 설정 화면](<../_assets/image_3_5.png>)
