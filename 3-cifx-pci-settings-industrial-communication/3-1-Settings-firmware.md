...
![[Figure 3.1-1 PCI Slot Setting]](<../_assets/3-cifx-pci-settings-industrial-communication/3.1-Setting-Firmware/image_1.png>)

![[Figure 3.1-2 PCI Slot Setting (master)]](<../_assets/3-cifx-pci-settings-industrial-communication/3.1-Setting-Firmware/image_2.png>) ![[Figure 3.1-3 v (slave)]](<../_assets/3-cifx-pci-settings-industrial-communication/3.1-Setting-Firmware/image_3.png>)
...
![[Figure 3.1-4 PCI Slot Setting]](<../_assets/3-cifx-pci-settings-industrial-communication/3.1-Setting-Firmware/image_4.png>)
...
![[Figure 3.1-5 Industrial Communication Setting Screen]](<../_assets/3-cifx-pci-settings-industrial-communication/3.1-Setting-Firmware/image_5.png>)
