...
{% hint style="info" %}
\.      "[\.      请按照“**1.3.10.1 EtherNet/IP - 标准Remote IO连接设置**”流程进行设置。](../../3-cifx-pci-settings-industrial-communication/10-EtherNet-IP-Remote-IO/1-Settings-EtherNet-IP-Remote-IO.md)" 절차를 따라 설정을 진행해 주십시오.
{% endhint %}
