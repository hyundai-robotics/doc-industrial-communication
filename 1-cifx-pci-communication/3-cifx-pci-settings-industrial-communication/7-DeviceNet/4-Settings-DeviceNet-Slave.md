...
{% hint style="warning" %}
**\[Achtung]**: Wenn eine mit Sycon.net konfigurierte Konfigurationsdatei auf den entsprechenden PCI-Steckplatz heruntergeladen ist, werden die TP-Einstellungen ignoriert.
{% endhint %}
