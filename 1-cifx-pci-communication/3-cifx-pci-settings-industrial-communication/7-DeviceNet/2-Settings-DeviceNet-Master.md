...
##### 1. Select the DeviceNet master in the industrial communication firmware settings and reboot the robot controller.

![[Figure 1.3.7.2-1 Firmware Settings]](<../../../_assets/1-cifx-pci-communication/3-cifx-pci-settings-industrial-communication/7-DeviceNet/2-Master_setting/image_1.png>)
...
\.      **원활한 통신 연결을 위해 (“[\.      **For smooth communication connection, be sure to check ("**1.3.7.5 DeviceNet ERROR Handling**").**](../7-DeviceNet/5-Error-DeviceNet.md)”)을 반드시 확인해 주십시오.**
{% endhint %}
