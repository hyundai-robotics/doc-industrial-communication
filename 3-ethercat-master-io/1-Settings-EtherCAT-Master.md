...
{% hint style="info" %}
\.      **통신 상태에서 ERROR 발생시 (“[\.      Sollte ein Fehler (ERROR) im Kommunikationsstatus auftreten, beachten Sie bitte den Abschnitt („3.2 Fehlerbehandlung bei EtherCAT-Master-E/A“).](../3-ethercat-master-io/2-Error-EtherCAT-Master.md)”)를 확인해 주십시오.**
{% endhint %}
