...
이 장에서는 EtherNet/IP 어댑터와의 외부 스캐너 장치 연결 방법을 설명합니다.  <br>### 2.3.3.1 LS ELECTRIC PLC와의 연결
...
[www.hd-hyundairobotics.com](https://hd-hyundairobotics.com/) -> 산업용 로봇 홈페이지 -> 고객지원 -> 응용소프트웨어에서 “**${cont_model} Fieldbus Config**”을 다운로드 합니다.
