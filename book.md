...
Hi6 제어기는 “**Sycon.net**” 프로그램을 이용하여 산업용 통신 설정을 진행합니다. 설정 방법은 다음과 같습니다. (“[**1.1 Sycon.net 설치**](../../1-cifx-pci-install-program/1-sycon-net.md)”을 참고하여 설치해주시기 바랍니다.)
...
![[그림 1.3.2-8 Sycon.net]](<../../../_assets/1-cifx-pci-communication/3-cifx-pci-settings-industrial-communication/2-Setting-SYCON/image_8.png>)# 1.3.2.1 SYCON.NET 도움말
...
| Hub                            | 사용 가능                  |
| Switch                         | 사용 가능                  |# 1.3.3.2 EtherNet/IP Scanner 설정
...
| Data Transport Layer       | Ethernet II, IEEE 802.3   |
| Hub                        | 사용 가능                  |
| Switch                     | 사용 가능                  |# 1.3.3.4 EtherNet/IP Adapter 설정
...
| Data Transport Layer          | Ethernet II, IEEE 802.3   |
| Hub                           | 사용 불가능                |
| Switch                        | 제한 사용 가능 (Priority Tagging, LLDP 지원 필요) |# 1.3.4.2 PROFINET IO Controller 설정
...
![[그림 1.3.4.2-1 펌웨어 설정]](<../../../_assets/1-cifx-pci-communication/3-cifx-pci-settings-industrial-communication/4-PROFINET-IO/2-Master_setting/image_1.png>) 
...
![[그림 1.3.6.2-1 펌웨어 설정]](<../../../_assets/1-cifx-pci-communication/3-cifx-pci-settings-industrial-communication/6-PROFIBUS-DP/2-Master_setting/image_1.png>) 
...
| Data Transport Layer           | PROFIBUS FDL              |
| Hub                            | 해당 없음                  |
| Switch                         | 해당 없음                  |# 1.3.6.4 PROFIBUS-DP Slave 설정
...
| Data Transport Layer           | CAN frames                |
| Hub                            | 해당 없음                  |
| Switch                         | 해당 없음                  |# 1.3.7.4 DeviceNet Slave 설정
...
## 2.1 Hi6 EtherNet/IP 어댑터

### 2.1.1 소개
Hi6 로봇제어기는 다양한 종류의 산업용 통신 기능을 제공하고 있습니다. 그 중 EtherNet/IP 어댑터는 별도의 추가 하드웨어가 필요하지 않는 기능입니다. 해당 기능을 사용하기 위해서는 별도의 소프트웨어 라이선스를 구매가 필요합니다. 라이선스 구매는 HD 현대 로보틱스 부품사업팀으로 문의 바랍니다 <br>
...
|Transport Class|Class 1 I/O implicit|## 2.2 EtherNet/IP 어댑터 네트워크 설정
...
## 2.6 EtherNet/IP 스캐너와의 연결

이번장에서는 EtherNet/IP 스캐너와 Hi6 EtherNet/IP 어댑터와의 연결 방법을 설명합니다.  <br>### 2.6.1 LS ELECTRIC PLC와의 연결
...
#### 2.6.1.7 EtherNet/IP Adapter 설정
