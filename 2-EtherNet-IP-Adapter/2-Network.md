...
![hi6com.png](../_assets/EIP-ADAPTER/Network/hi6com.png)<br>
*[그림 5.2.1 Hi6 Com]*<br>

### 5.2.2 네트워크 설정
EtherNet/IP 통신을 연결할 LAN Port를 선택한 뒤 아래와 같이 TP화면을 통해 해당 LAN Port의 설정을 확인하고 필요에 따라 설정을 변경해야 합니다.<br>

![networkConfig.png](../_assets/EIP-ADAPTER/Network/networkConfig.png)<br>
*[그림 5.2.2 네트워크 설정]*<br>
...
![lanPort.png](../_assets/EIP-ADAPTER/Network/lanPort.png)<br>
*[그림 5.2.3 랜 포트]*<br>
...
![NG_Network.png](../_assets/EIP-ADAPTER/Network/NG_Network.png)<br>
*[그림 5.2.4 분리하지 않은 네트워크]*<br>

![Good_Network.png](../_assets/EIP-ADAPTER/Network/Good_Network.png)<br>
*[그림 5.2.5 분리된 네트워크]*<br>
