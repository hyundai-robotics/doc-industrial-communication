## 5.5 EtherNet/IP 어댑터 라이선스
### 5.5.1 라이선스의 활성화
초기화면에서 “시스템” > “2 : 제어 파라미터” > “10: 옵션기능의 라이선스키 등록” 으로 이동<br>
![license.png](../_assets/EIP-ADAPTER/License/license.png)<br>
*[그림 9.1.1 라이선스 활성]*<br>
...
~ 참고<br>
![license_ng.png](../_assets/EIP-ADAPTER/License/license_ng.png)<br>
*[그림 9.1.2 라이선스 활성화 안될시 나오는 메시지]*<br>
