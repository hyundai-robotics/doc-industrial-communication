...
![[그림 6.1 Hi6 Com]](../_assets/EIP-ADAPTER/Network/hi6com.png)

### 5.2.2 네트워크 설정
EtherNet/IP 통신을 연결할 LAN Port를 선택한 뒤 아래와 같이 TP화면을 통해 해당 LAN Port의 설정을 확인하고 필요에 따라 설정을 변경해야 합니다.<br>
![[그림 6.2 네트워크 설정]](../_assets/EIP-ADAPTER/Network/networkConfig.png)

{% hint style="warning" %}
LAN1/LAN2/LAN3 각각의 IP주소는 서브넷 부분을 다르게 설정해야 합니다.<br>
{% endhint %}  
{% hint style="warning" %}
설정을 변경한 후에는 로봇제어기를 재부팅 하십시오.<br>
{% endhint %}

### 5.2.3 연결 상태의 확인
랜 포트의 Link/Act Led의 상태에 따라 EtherNet/IP 스캐너와의 물리적 연결 상태를 확인할 수 있습니다.<br>
![[그림 6.3 랜 포트]](../_assets/EIP-ADAPTER/Network/lanPort.png)<br>
...
![[그림 6.4 분리하지 않은 네트워크]](../_assets/EIP-ADAPTER/Network/NG_Network.png)<br>
![[그림 6.5 분리된 네트워크]](../_assets/EIP-ADAPTER/Network/Good_Network.png)
